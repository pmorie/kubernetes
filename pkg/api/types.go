...
type PodSpec struct {
	...
	// SecurityContext holds pod-level security attributes and base container settings
...
// PodSecurityContext holds pod-level security attributes and defaults for container-level settings.
type PodSecurityContext struct {
	...
	// ContainerDefaults hold base security settings that apply to all containers in a pod.
	// Optional.
	ContainerDefaults *SecurityContext `json:"containerDefaults,omitempty"`
}
