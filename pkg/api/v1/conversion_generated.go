...
func autoConvert_api_MapKeySelector_To_v1_MapKeySelector(in *api.MapKeySelector, out *MapKeySelector, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
...
func Convert_api_MapKeySelector_To_v1_MapKeySelector(in *api.MapKeySelector, out *MapKeySelector, s conversion.Scope) error {
...
func autoConvert_v1_MapKeySelector_To_api_MapKeySelector(in *MapKeySelector, out *api.MapKeySelector, s conversion.Scope) error {
	if defaulting, found := s.DefaultingInterface(reflect.TypeOf(*in)); found {
		defaulting.(func(*MapKeySelector))(in)
	}
...
func Convert_v1_MapKeySelector_To_api_MapKeySelector(in *MapKeySelector, out *api.MapKeySelector, s conversion.Scope) error {
