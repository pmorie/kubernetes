...
mkdir -p /srv/salt/deployment-controller/go
cp -R --preserve=mode $RELEASE_BASE/src/go/* /srv/salt/deployment-controller/go

mkdir -p /srv/salt/job-controller/go
cp -R --preserve=mode $RELEASE_BASE/src/go/* /srv/salt/job-controller/go
